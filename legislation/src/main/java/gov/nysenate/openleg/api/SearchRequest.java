...
public class SearchRequest extends AbstractApiRequest {
    ...
    private QueryBuilder editQBuilder(Request request, QueryBuilder queryBuilder){
    ...
    private QueryBuilder createRange(QueryBuilder queryBuilder, Date startDate, Date endDate) throws java.text.ParseException{
    ...
    private QueryBuilder useTerms(QueryBuilder queryBuilder){
    ...
    public void fillRequest() throws ApiRequestException {
        ...
        try {
            ...
            queryBuilder = useTerms(queryBuilder);
            ...
            Date endDate =  null;
            try {
                queryBuilder = createRange(queryBuilder, startDate, endDate);
            ...
            queryBuilder = editQBuilder(result, queryBuilder);
        ...
        else(format.equalsIgnoreCase("csv")) {
            return;
        }
    ...
    private void workOnTerm(QueryBuilder queryBuilder)throws ApiRequestException{
    ...
    private String controlParam(String str){
    ...
    private Integer parseInt (String str){
        ...
        if(request.getParameter(str) != null){
            integer = Integer.parseInt(request.getParameter(str));
        }
    ...
    private boolean controlTerm(){
        boolean flag = false;
        if(term != null && !term.contains("year:") && !term.contains("when:") && !term.contains("oid:")){
            flag = true;
        }
        else if(!term.contains("oid:") && !term.contains("active:")){
            flag = true;
        }
